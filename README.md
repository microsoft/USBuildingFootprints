...
2. Consecutive edge angles are likely to be 90^\circ
3. Consecutive angles cannot be very sharp, smaller by some auto-tuned threshold, e.g. 30^\circ
4. Building angles likely have very few dominant angles, meaning all building edges are forming angle of (dominant angle \pm n*\pi/2)
